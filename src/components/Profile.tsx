...
export default function ProfileClient({
  ...
  const handleConfirmChange = async () => {
    ...
    try {
      ...
      toast.error(e instanceof Error ? e.message : "Erro ao atualizar perfil.", { closeButton: true });
    } finally {
  ...
  const getCalendarData = async () => {
    ...
    try {
      toastId = toast.loading("A carregar...");
      ...
      toast.dismiss(toastId);
      toast.error(e instanceof Error ? e.message : "Erro ao obter link do calendário.", { closeButton: true });
      return null;
    }
  };
  ...
  const onCvUpload = async (file: File | null) => {
    ...
    if (file.type !== "application/pdf") {
      toast.error("Envie apenas ficheiros PDF.", { closeButton: true });
      return;
    }
    setCvLoading(true);
    let cvToastId: string | number = "";
    try {
      cvToastId = toast.loading("A enviar CV...");
      ...
      toast.error(e instanceof Error ? e.message : "Erro ao enviar o CV.", { closeButton: true });
    } finally {
      setCvLoading(false);
    }
  };
  ...
  const onCvRemove = async () => {
    ...
    try {
      ...
      toast.error(e instanceof Error ? e.message : "Erro ao remover o CV.", { closeButton: true });
    } finally {
      setCvLoading(false);
    }
  };
  ...
  const onCvDownload = async () => {
    ...
    try {
      ...
      toast.error(e instanceof Error ? e.message : "Erro ao descarregar o CV.", { closeButton: true });
    } finally {
      setCvLoading(false);
    }
  };
