...
## [4.0.0](https://github.com/tomasmbrito/neiist-website/compare/v3.0.0...v4.0.0) (2026-09-14)
...
* add nextjs cache to build step on github action ([03591bc](https://github.com/tomasmbrito/neiist-website/commit/03591bc7acc0bc90d02a7b514c10c2e42a2dca92))
...
* **cache:** add revalidateTag to all mutation API routesupdateTag ([a3a96a1](https://github.com/tomasmbrito/neiist-website/commit/a3a96a10c4d3a753461e9fd81f3e3bc05e3824cb))
* **campuses:** add to about us page a campus room location tabs ([c8fdbd7](https://github.com/tomasmbrito/neiist-website/commit/c8fdbd787aa61a5f8a21f0ff48d0afa4397dfa37))
...
* **ci:** add lint, type check and formating to an action run ([d49db3b](https://github.com/tomasmbrito/neiist-website/commit/d49db3b72220c4d00f948ee83cd81f8e63a8b7ca))
...
* **db:** add sql batch functions (memberships, department roles, products) and stale order query ([a38f3ce](https://github.com/tomasmbrito/neiist-website/commit/a38f3cebfe2e973b7173ff6ccaeab06b7683fa4c))
...
* **deploy:** build on github actions, send only built artifact to ([064667a](https://github.com/tomasmbrito/neiist-website/commit/064667abec484c74b8d72ec5c3e82bf47aff7a48))
...
* **dinner:** add voting button and styles to UnlockedDinnerPage ([b662315](https://github.com/tomasmbrito/neiist-website/commit/b662315ef79891067de0e8bf97b2e353cfdb5c69))
* **dinner:** disable dinner page (only for admins, remove from nav) ([cbc45e7](https://github.com/tomasmbrito/neiist-website/commit/cbc45e7fe8963b8b26f07f90ea8d7a2c7b8faee3))
* **drive:** separated util for drive upload and jwt crypto fix ([aa01bf3](https://github.com/tomasmbrito/neiist-website/commit/aa01bf378ea4a03e520f8d573eeb47938e046d56))
...
* **error:** add error page, default error pages ([46d00ff](https://github.com/tomasmbrito/neiist-website/commit/46d00ff94e177661591e9d571aa2d832dab579e5))
...
* **homepage:** update copyright to 2026 remove Partnerships from home ([6dee5a0](https://github.com/tomasmbrito/neiist-website/commit/6dee5a062ae4086d20f54e0fe777f33ad09076b7))
* **i18n:** add cookie-based i18n (en, pt) with server-side dictionaries ([f0bfd19](https://github.com/tomasmbrito/neiist-website/commit/f0bfd19382a4a58cc21ddeec706f2e789bd90fe3))
...
* **joinUs:** add join us banner to about us page ([e34f0a0](https://github.com/tomasmbrito/neiist-website/commit/e34f0a07a72e9c73b816a0f6bf23b33c472b28b5))
...
* load google service accouts from env not from json files ([b173609](https://github.com/tomasmbrito/neiist-website/commit/b17360982087fee3f3831fb9a336bd46498d558f))
...
* migrate google api to google service accounts. Script to backup db prod and staging ([bc83bc4](https://github.com/tomasmbrito/neiist-website/commit/bc83bc461d92065d7f4f51804b3de97ed47a267a))
...
* **navbar:** language switcher on mobile is on the dropdwon menu ([8150103](https://github.com/tomasmbrito/neiist-website/commit/8150103f8a656175cda76d76ec989b8484448cd5))
...
* **orders:** add archive option (only show current academic year orders) ([1c4a182](https://github.com/tomasmbrito/neiist-website/commit/1c4a182195855ae991477f254344e4f584ae67dd))
...
* **permissions:** centralize all roles and permissions checks ([62ad383](https://github.com/tomasmbrito/neiist-website/commit/62ad383a58a4459fd060e04ef61f22f2d61bd872))
...
* **search:** new universal search, implemented with mini search engine ([a69122c](https://github.com/tomasmbrito/neiist-website/commit/a69122c9bc89008bfd06bbc0d097f7496ba1fda0))
...
* **shop:** add cascading flyout menu to filter product variants ([8c84070](https://github.com/tomasmbrito/neiist-website/commit/8c84070c3a00807b96d21a05af4d376386826be8))
* **shop:** add estimated delivery and customizable size SizeGuideEditor ([c5e6786](https://github.com/tomasmbrito/neiist-website/commit/c5e678610389fad87972c2026f72aee6d276b57a))
* **shop:** add order_start sql functions logic and UI updates ([8409e22](https://github.com/tomasmbrito/neiist-website/commit/8409e2250a74e77ee4fef9f42928bda9b2fcfdd5))
...
* **shop:** image uploads api stored in data/ get route via filename ([4b34079](https://github.com/tomasmbrito/neiist-website/commit/4b34079e3d656edfefca8b3ef42679d5c81d64c1))
* **shop:** introduce campus schedule modal and unify pending payment overlays ([5a1eea0](https://github.com/tomasmbrito/neiist-website/commit/5a1eea0046fe17b7e8ed3049d82f0114034abb9a))
...
* **shop:** startup instrumentation for auto-cancel and db seeding ([3778099](https://github.com/tomasmbrito/neiist-website/commit/3778099b55bcda195af2cdecef1206ea2c3b87d6))
...
* **ui:** implement ui library @neiist/ui as a sub package ([6924125](https://github.com/tomasmbrito/neiist-website/commit/692412589bfe909fe02185508fc0854581d426f5))
...
* **ui:** separate client components from RSC ones, accordion refactor ([d578b3b](https://github.com/tomasmbrito/neiist-website/commit/d578b3b0c2711513e0fa27fd13f1591149a44efe))
...
* update packages with security vulnerabilities ([141b9f8](https://github.com/tomasmbrito/neiist-website/commit/141b9f832050197dfe030752cb57e86bd6c7cf22))
...
* **user:** implement GDPR-compliant account deletion with order pii redaction ([4a7e820](https://github.com/tomasmbrito/neiist-website/commit/4a7e820f6fbea77e8ce313359e5607bd26d3bb1c))
* **voting:** better mobile ui, voting session tabs, vote feedback, and route suspense ([67e40cc](https://github.com/tomasmbrito/neiist-website/commit/67e40cc55cc49460dd37d8281dda69b48456a383))
* **voting:** new pg_notify based SSE backend. New pages for management, vote and wait for voting to start. Make shop filtering components universal. ([9d1422e](https://github.com/tomasmbrito/neiist-website/commit/9d1422e6b42192e4fb84f627d638559edc7df141))
* **votingSystem:** optimize SSE pub/sub architecture and fix stale state amnesia ([41154f9](https://github.com/tomasmbrito/neiist-website/commit/41154f91d36e34e240d4f1cfdaf04261b83cc8e7))
* **voting:** voting system using postgres state sync between client ([5d0a9f9](https://github.com/tomasmbrito/neiist-website/commit/5d0a9f901ef9c896915e561e9a00b6afa3dba499))
...
* **api:** nextjs pre-render breaking and using NextRequest to parse url ([e3dd516](https://github.com/tomasmbrito/neiist-website/commit/e3dd5164270606381905e5c1d379de9952efaf82))
* **api:** use correct base url on callback route fenix ([181420b](https://github.com/tomasmbrito/neiist-website/commit/181420b802eafbabef699b04f6938484638a0aa4))
* **app:** wrap user context in suspense and add app general loading spinner ([b500ed4](https://github.com/tomasmbrito/neiist-website/commit/b500ed413130b3413812c0ca736d1e0a5125a739))
* **auth:** auth and account creation for user with multiple courses ([20c9d69](https://github.com/tomasmbrito/neiist-website/commit/20c9d69e7f8e3f9e7a09b6d5f0da00a47ee5a38d))
* **auth:** await cookies() outside of try/catch block so it doesnt break ([59d4424](https://github.com/tomasmbrito/neiist-website/commit/59d442420ca3f302b3fbc5a2bfd5d690fd0f3ed9))
...
* **auth:** fix post-login destination redirects and refactor server auth helpers ([f2a77e4](https://github.com/tomasmbrito/neiist-website/commit/f2a77e404e20435ae09a041fcea8b9425e4f1771)), closes [#678](https://github.com/tomasmbrito/neiist-website/issues/678)
* **auth:** migrate to standard Web Crypto API for JWT verification and signing ([9a8c83d](https://github.com/tomasmbrito/neiist-website/commit/9a8c83d497c01085cd1a3857444d4ca95144f212))
* **auth:** protect routes and server pages with requireRoles using new jwt, order PII Redaction ([8417213](https://github.com/tomasmbrito/neiist-website/commit/8417213ed3c0f62d3cfcf9267a72f9ed90c115f4))
...
* **calendar:** decouple notion webhook response from events sync to db ([de02d33](https://github.com/tomasmbrito/neiist-website/commit/de02d3319c3d6de372ef40bc694a293124b76e00))
...
* **ci:** generate nextjs types before running lint and type checker ([74f092f](https://github.com/tomasmbrito/neiist-website/commit/74f092f5167147e22536ce55ae3c50b16c7ff554))
* **ci:** make deploy workflow depend on the lint workflow ([99ab3bd](https://github.com/tomasmbrito/neiist-website/commit/99ab3bd35be7abed9267bdd1b77cfaa844766919))
* **ci:** stage deploy blocked until sucessful linting ([b4e0724](https://github.com/tomasmbrito/neiist-website/commit/b4e07243e9468572497aef5c19d34a71cd6ec54c))
...
* **deploy:** correct git tags fetching on the server ([ca2a9ec](https://github.com/tomasmbrito/neiist-website/commit/ca2a9ec14cbfa2a37fbeacb1f67cc71a3c5755ca))
...
* **deploy:** pm2 check on github action ([7df9229](https://github.com/tomasmbrito/neiist-website/commit/7df9229fc572f2907cafe607e07dbeaacfb2f35c))
* **deps:** update dependency axios to v1.10.0 ([#497](https://github.com/tomasmbrito/neiist-website/issues/497)) ([181138a](https://github.com/tomasmbrito/neiist-website/commit/181138acc6af10b06b61456d354dddd2396c16a0))
* **deps:** update dependency axios to v1.11.0 [security] ([#526](https://github.com/tomasmbrito/neiist-website/issues/526)) ([31c8820](https://github.com/tomasmbrito/neiist-website/commit/31c88201c97359f6534d54e00fd454c78685b4ca))
...
* **deps:** update dependency bootstrap to v5.3.7 ([#484](https://github.com/tomasmbrito/neiist-website/issues/484)) ([7e8de79](https://github.com/tomasmbrito/neiist-website/commit/7e8de79f82ff7d269cf473913b8943ecca1ceb37))
...
* **deps:** update dependency dotenv to v17 ([#504](https://github.com/tomasmbrito/neiist-website/issues/504)) ([159e857](https://github.com/tomasmbrito/neiist-website/commit/159e85787dfb6514fd898ce15316df99bfaae53b))
* **deps:** update dependency dotenv to v17.0.1 ([#505](https://github.com/tomasmbrito/neiist-website/issues/505)) ([33cca2b](https://github.com/tomasmbrito/neiist-website/commit/33cca2b6bdc25bbe0a12829506347c20cfa64b90))
* **deps:** update dependency dotenv to v17.2.0 ([#509](https://github.com/tomasmbrito/neiist-website/issues/509)) ([6ded998](https://github.com/tomasmbrito/neiist-website/commit/6ded998e6ed919544d04fe08eeb1b47e9c753cb0))
* **deps:** update dependency dotenv to v17.2.1 ([#529](https://github.com/tomasmbrito/neiist-website/issues/529)) ([399e2e9](https://github.com/tomasmbrito/neiist-website/commit/399e2e9a6501be7c337a0cea4d8755d80a3068d5))
...
* **deps:** update dependency express-fileupload to v1.5.2 ([#507](https://github.com/tomasmbrito/neiist-website/issues/507)) ([858cfd2](https://github.com/tomasmbrito/neiist-website/commit/858cfd2ad3ac77280f41eaee983fe24d16f1e71c))
* **deps:** update dependency express-session to v1.18.2 ([#517](https://github.com/tomasmbrito/neiist-website/issues/517)) ([72a8c38](https://github.com/tomasmbrito/neiist-website/commit/72a8c38899435af9cf4ca6bddf91f333209d731b))
* **deps:** update dependency html-react-parser to v5.2.6 ([#520](https://github.com/tomasmbrito/neiist-website/issues/520)) ([c09afec](https://github.com/tomasmbrito/neiist-website/commit/c09afec89e50bc692968421e092eec0a9c509c6d))
* **deps:** update dependency morgan to v1.10.1 ([#518](https://github.com/tomasmbrito/neiist-website/issues/518)) ([d5c7493](https://github.com/tomasmbrito/neiist-website/commit/d5c74937af0959dd281f4bf8fdff45ee016a4d4c))
* **deps:** update dependency natural to v8.1.0 ([#499](https://github.com/tomasmbrito/neiist-website/issues/499)) ([bf03a37](https://github.com/tomasmbrito/neiist-website/commit/bf03a37185813e9561c7ef0b471bb5cedc73d9c7))
* **deps:** update dependency pg to v8.16.3 ([#500](https://github.com/tomasmbrito/neiist-website/issues/500)) ([582eca5](https://github.com/tomasmbrito/neiist-website/commit/582eca5e3584a0eff19d81c2e7b9acab09cc047e))
* **deps:** update dependency react-router-dom to v7.6.3 ([#478](https://github.com/tomasmbrito/neiist-website/issues/478)) ([40d56b2](https://github.com/tomasmbrito/neiist-website/commit/40d56b20f414e82c89f25edf41e5f7c42df8989f))
* **deps:** update dependency react-router-dom to v7.7.0 ([#515](https://github.com/tomasmbrito/neiist-website/issues/515)) ([f5a4725](https://github.com/tomasmbrito/neiist-website/commit/f5a4725cbe8b3269bf516a5f0db0265bcee3b723))
* **deps:** update dependency react-router-dom to v7.7.1 ([#528](https://github.com/tomasmbrito/neiist-website/issues/528)) ([6b946c4](https://github.com/tomasmbrito/neiist-website/commit/6b946c4bbf5c7b174a986bf9a036f17d9445881c))
...
* **deps:** update dependency react-select to v5.10.2 ([#512](https://github.com/tomasmbrito/neiist-website/issues/512)) ([b88f1e2](https://github.com/tomasmbrito/neiist-website/commit/b88f1e28bd051aeea1f0ed9d3ab91f72aefe341f))
* **deps:** update mantine monorepo to v8.1.2 ([#501](https://github.com/tomasmbrito/neiist-website/issues/501)) ([05382d2](https://github.com/tomasmbrito/neiist-website/commit/05382d23cfa858c8af4232f83c7af96bdf9ccde6))
* **deps:** update mantine monorepo to v8.1.3 ([#508](https://github.com/tomasmbrito/neiist-website/issues/508)) ([1c916f6](https://github.com/tomasmbrito/neiist-website/commit/1c916f6e5fe110f0811fb4c498fd2237bd780052))
* **deps:** update mantine monorepo to v8.2.1 ([#522](https://github.com/tomasmbrito/neiist-website/issues/522)) ([ef68d08](https://github.com/tomasmbrito/neiist-website/commit/ef68d084a4c53a7998b21f06b3b8ed8dd06f5517))
...
* **deps:** update react monorepo to v19.1.1 ([#531](https://github.com/tomasmbrito/neiist-website/issues/531)) ([97247cf](https://github.com/tomasmbrito/neiist-website/commit/97247cf946d854866ce6a036aabb88f3dd72c243))
...
* **dinner:** refactor dinner page logic and state handling ([c9bf727](https://github.com/tomasmbrito/neiist-website/commit/c9bf7275fd36eb251f3d14ea44c69bdb8fa64e19))
...
* **layout:** replace self-loopback HTTP fetch with a server side call to ([311845a](https://github.com/tomasmbrito/neiist-website/commit/311845a9db1f3b64d934acb8f4ba4bb3856eb2df))
* **layout:** static render navbar only auth widget is dynamic ([7354025](https://github.com/tomasmbrito/neiist-website/commit/7354025dc6ca1ce06ec562f4135223f476ddf650))
...
* **login:** use correct base url on redirect ([6223f35](https://github.com/tomasmbrito/neiist-website/commit/6223f357658ce85ff54e2e5c579622ef73324ec7))
...
* navbar dropdown on 768px devices and icon picker search adjust ([0171143](https://github.com/tomasmbrito/neiist-website/commit/01711437e6c32d4a069329f42e21cda43968aeeb))
...
* **scripts:** manage manage-calendars, setup google and setup notion ([a1cb866](https://github.com/tomasmbrito/neiist-website/commit/a1cb8662e23d1770969ebceb6c7f8f8e44a29ff9))
...
* **shop:** prevent race condion and duplicate emails in order finalization ([87e11e2](https://github.com/tomasmbrito/neiist-website/commit/87e11e269d150a477ac52a944532b8f9e8206971))
...
* **styles:** adjust margins and alignment for improved layout on DinnerPage ([8839a0c](https://github.com/tomasmbrito/neiist-website/commit/8839a0c2b19b87187494dd599f1fb756e823e0ca))
* **styles:** adjust margins and layout for improved spacing on DinnerPage ([92331e9](https://github.com/tomasmbrito/neiist-website/commit/92331e9917b88df2bae62f1f76bb1ae896d720ef))
...
* **styles:** normalize margins for main title and welcome message in DinnerSurprises ([0b9de7f](https://github.com/tomasmbrito/neiist-website/commit/0b9de7fcfb606a3163f4bcd0ba532b2c42b19aa0))
...
* **sumup:** singleton client error handeling and overlay index ([fca7aa4](https://github.com/tomasmbrito/neiist-website/commit/fca7aa48adc9b1b153ecfeaede73773e803e8d99))
* **sumup:** verify exact cent amount match and currencybind ([d034dcf](https://github.com/tomasmbrito/neiist-website/commit/d034dcf62a48fba583b3938d595ca3b4ad8b720d))
...
* **ui-tabs:** animation and corner blue accent line ([1b8437f](https://github.com/tomasmbrito/neiist-website/commit/1b8437faea9ffa1da2ed2a1926aaff2a3fd0da23))
...
* **voting:** fix SSE and pg_notify memory and db connections leak. UI/UX improvements on the user vonting screen ([c20dc75](https://github.com/tomasmbrito/neiist-website/commit/c20dc7516db350f3eb97cc7717e9f8e8eea617e3))
...
* migrate to pnpm, new db seed script and updated deployments ([55ff382](https://github.com/tomasmbrito/neiist-website/commit/55ff382af397652d7d7119b306e2416d651cc847)), closes [#656](https://github.com/tomasmbrito/neiist-website/issues/656)
